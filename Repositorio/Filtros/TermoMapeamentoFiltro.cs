...
namespace EscudoNarrador.Repositorio.Filtros
{
    ...
    {
        public TermoMapeamentoFiltro(string sistema, string nome, string[] tags)
        {
            AdicionarRegra(c => c.PartitionKey.Equals(sistema)).SobCondicional(c => !sistema.LimpoNuloBranco());
